\revhist{3/17/87, pss; 4/1/91, pss; 9/9/91, ps; 11/18/93, pss; 10/13/94, pss;
         ...
         3/3/2000, pss}
%
\defModTitle{\ph{Simple Harmonic Motion:} \ph{Shifted Origin and Phase}}
\defCtAuthor{Kirby Morgan}
...
\defIdItems{
    ...
    \item [3.] Find solutions of the equation: \m{d^2x/dt^2\,+\,\omega^2\,x\,=\,0}.
    \end{InputSkills}
    %
    ...
    mass \m{m} and force constant \m{k} for a simple harmonic oscillator.
    \end{KnowledgeSkills}
    %
    ...
    Solve for the following functions of time as equations with symbols, numbers, and/or graphs
    as requested: displacement, velocity, acceleration.
